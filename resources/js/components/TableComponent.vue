<template>
  <div class="block m-3">
    ...
    <div class="block-content">
      ...
      <div>
        <button type="button" class="btn btn-outline-info mr-1 float-right mb-2" 
        ...
        <table class="table table-bordered table-vcenter" v-if="customer_flag">
          <thead>
            <tr>
              <th class="text-center" style="width: 50px">#</th>
              <th>Contract_no</th>
          ...
          <tbody>
            <tr v-for="payment in payments" v-bind:key="payment.contract_no">
              <th class="text-center" scope="row">
                {{ payment.id }}
              </th>
              <td class="font-w600 font-size-sm">
                <a
                  href="javascript:void(0);"
                  @click="getCustomerData(payment.contract_no)"
